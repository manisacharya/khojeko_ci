<?php
$item_num = ($per_page*($page_number-1)+count($unverified_dealer));
if ($item_num>$total)
    $item_num = 0;
?>
<div class="col-sm-12">
    <div class="active_inactive">
        <form class="search" method="get" action="<?php echo base_url('admin/inactive_adv_dealer') ?>">
    ...
    <div class="inactive_ads">
        <form method="post" action="<?php echo base_url('admin/Admin_pages/verify_validation/inactive_adv_dealer') ?>">
            <div class="top_title">
            ...
            <ol>
                <?php foreach ($unverified_dealer as $row):?>
                    <li>
                            <span>
                        ...
                        <span>
                                    ...
                                    if($sales_status){
                                        ?>
                                        <a href="<?php echo base_url("admin/Admin_pages/sold_unsold/".$item_id."/".$sales_status."/inactive_adv_dealer") ?>" class="red">Sold</a><br>
                                    <?php } else { ?>
                                        <a href="<?php echo base_url("admin/Admin_pages/sold_unsold/".$item_id."/".$sales_status."/inactive_adv_dealer") ?>" class="green">Unsold</a><br>
                                    <?php }
                                    $visibility = $row->visibility;
                                    if($visibility){
                                        ?>
                                        <a href="<?php echo base_url("admin/Admin_pages/hide_unhide/".$item_id."/".$visibility."/inactive_adv_dealer") ?>" class="red">Hide</a><br>
                                    <?php } else { ?>
                                        <a href="<?php echo base_url("admin/Admin_pages/hide_unhide/".$item_id."/".$visibility."/inactive_adv_dealer") ?>" class="green">Unhide</a><br>
                                    <?php } ?>
                                </span>

                        <span>
                                    <a title="delete" href="<?php echo base_url("admin/Admin_pages/delete/".$item_id."/inactive_adv_dealer") ?>"><i class="fa fa-trash" style="color:red"></i></a>
                        ...
                        <span>
                                    ...
                                    if($premium){
                                        ?>
                                        <a href="<?php echo base_url("admin/Admin_pages/premium/".$item_id."/".$premium."/inactive_adv_dealer") ?>" class="green">Not Premium</a><br>
                                    <?php } else { ?>
                                        <a href="<?php echo base_url("admin/Admin_pages/premium/".$item_id."/".$premium."/inactive_adv_dealer") ?>" class="red">Premium</a><br>
                                    <?php } ?>
